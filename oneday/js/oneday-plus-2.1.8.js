...
jQuery( document ).ready( function( $ ){
	...
	var renderVideoTag = function( $s ) {
		...
		if ( video_mp4 || video_webm || video_ogv ) {
			...
			$v.html( oneday_Plus.browser_warning );
			if ( video_mp4 ) {
            ...
            project.on( 'click', function( e ){
                ...
                if ( project.hasClass( 'active' ) ) {
                    ...
                    if ( $( '.project-expander', project ).length  > 0 ) {
                        ...
                        if (  post_id ) {
                            $.ajax( {
                                url: oneday_Plus.ajax_url,
                                data: { action: 'oneday_plus_ajax', oneday_ajax_action: 'load_portfolio_details', post_id: post_id },
                                dataType: 'json',
                                type: 'post',
